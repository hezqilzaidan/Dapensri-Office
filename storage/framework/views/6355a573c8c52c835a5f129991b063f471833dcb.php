...
<script>
    ...
    $(document).ready(function(){
           var oTable= $('#dataKar').DataTable({
            ...
            scrollY: 400,
            ajax :{
              url: "<?php echo e(url('userMob/getData')); ?>",
              type:'GET',
            //   dataSrc:''
            },
            columns: [
    ...
    $('#tombol-tambah').click(function () {
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "<?php echo e(url('userMob/delete/')); ?>"+"/"+ dataId, //eksekusi ajax ke url ini
                type: 'GET',
        ...
        $.ajax({
            type : 'POST',
            url  : "<?php echo e(url('userMob/register')); ?>",
...
<?php echo $__env->make('layout.admin.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dapensri-office\resources\views/userMob.blade.php ENDPATH**/ ?>