            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo e(url('/spt/import')); ?>" enctype="multipart/form-data" >
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-sm-12">
...
<script>
    ...
    $(document).ready(function(){
           var oTable= $('#dataKar').DataTable({
            ...
            scrollX:1200,
            ajax :{
              url: "<?php echo e(url('spt/getData')); ?>",
              type:'GET',
            //   dataSrc:''
            },
            columns: [
    ...
    $('#dataKar').on('click', '.editDatas', function(){
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "<?php echo e(url('/spt/delete/')); ?>"+"/"+ dataId, //eksekusi ajax ke url ini
                type: 'DELETE',
...
<?php echo $__env->make('layout.admin.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dapensri-office\resources\views/spt.blade.php ENDPATH**/ ?>