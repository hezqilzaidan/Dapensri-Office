        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="<?php echo e(url('export_excel')); ?>" class="btn  btn-success" ><li class="la la-file-excel-o"></li> <span> EXPORT DATA </span></a>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layout.admin.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dapensri-office\resources\views/list_ex.blade.php ENDPATH**/ ?>