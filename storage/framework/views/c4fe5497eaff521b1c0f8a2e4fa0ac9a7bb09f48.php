        ...
        <div class="page-body">
            <form action="/datadiri/store" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="badge" name="badge" class="form-control" value="<?php echo e($data->badge); ?>"
                        readonly>
                </div>
                ...
                <div class="form-group">
                    <label>NIK</label><br>
                    <input type="text" id="nik" name="nik" class="form-control" value="<?php echo e($data->nik); ?>"
                        readonly>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="no_kk" name="no_kk" class="form-control" value="<?php echo e($data->no_kk); ?>"
                        readonly>
                </div>
                <div class="form-group">
                    <label>Tempat Lahir</label>
                    <input type="text" id="tmpt_lahir" name="tmpt_lahir" class="form-control"
                        value="<?php echo e($data->tmpt_lahir); ?>" readonly>
                </div>

                <div class="form-group">
                    <label>Tanggal Lahir</label> <br>
                    <input type="date" id="tgl_lahir"name="tgl_lahir" class="form-control" value="<?php echo e($data->tgl_lahir); ?>"
                        readonly>
                </div>
                ...
                <div class="page-body">
                    ...
                    <div class="form-group">
                        <input type="text" id="kode_pos" name="kode_pos" class="form-control" placeholder="Kode Pos"
                            value="<?php echo e($data->kode_pos); ?>">
                    </div>
                    ...
                    <div class="page-body">
                        ...
                        <div class="form-group">
                            <input type="number" id="no_rek" name="no_rek" class="form-control"
                                placeholder="No Rekeneing" value="<?php echo e($data->no_rek); ?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <input type="text" id="atas_nama" name="atas_nama" class="form-control"
                            placeholder="Nama Pemilik" value="<?php echo e($data->atas_nama); ?>">
                    </div>
                    ...
                    <div class="page-body">
                        ...
                        <div class="form-group">
                            <input type="number" id="no_hp" name="no_hp" class="form-control"
                                placeholder="No HP" value="<?php echo e($data->no_hp); ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="page-body">
                            ...
                            <div class="form-group">
                                <input type="radio" name="st_pensiun" value="sendiri"
                                    <?php echo e($data->st_pensiun == 'sendiri' ? 'checked' : ''); ?>> Sendiri </br>
                                <input type="radio" name="st_pensiun" value="janda"
                                    <?php echo e($data->st_pensiun == 'janda' ? 'checked' : ''); ?>> Janda </br>
                                <input type="radio" name="st_pensiun" value="duda"
                                    <?php echo e($data->st_pensiun == 'duda' ? 'checked' : ''); ?>> Duda </br>
                                <input type="radio" name="st_pensiun" value="yatim"
                                    <?php echo e($data->st_pensiun == 'yatim' ? 'checked' : ''); ?>> Yatim </br>
                            </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, element) {
                            if (element.name == '<?php echo e($data->provinsi); ?>') {
                                prov_id = element.id;
...
<?php echo $__env->make('layout.user.mainlayout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dapensri\resources\views/datadiri.blade.php ENDPATH**/ ?>