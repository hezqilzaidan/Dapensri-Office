...
<script>
    ...
    $(document).ready(function(){
           var oTable= $('#dataKar').DataTable({
            ...
            scrollY: 390,
            ajax :{
              url: "<?php echo e(url('lapKeu/getData')); ?>",
              type:'GET',
            //   dataSrc:''
            },
            columns: [
    ...
    $('#dataKar').on('click', '.deleteData', function(){
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "<?php echo e(url('lapKeu/delete/')); ?>"+"/"+ dataId, //eksekusi ajax ke url ini
                type: 'GET',
...
<?php echo $__env->make('layout.admin.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dapensri-office\resources\views/lapKeu.blade.php ENDPATH**/ ?>